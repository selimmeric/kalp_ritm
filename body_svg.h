...
// Bu SVG, kullanıcı tarafından sağlanan estetik silüetin üzerine, 
// projenin gerektirdiği 16 adet interaktif nabız noktasının eklenmesiyle oluşturulmuştur.
const char BODY_SVG[] PROGMEM = R"rawliteral(
<svg fill="#cccccc" version="1.1" id="HumanBody" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="800px" height="800px" viewBox="0 0 206.326 206.326" xml:space="preserve">
<g>
	<!-- Sizin gönderdiğiniz ana vücut silüeti -->
...
<!-- Üzerine eklenen 16 interaktif nabız noktası -->
<g id="pulse-points" stroke="#212529" stroke-width="0.5">
    <circle class="pulse-point" id="pulse_point_0" title="Temporal (Şakak)" cx="95.5" cy="27" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_1" title="Carotid (Şah Damarı)" cx="107" cy="51" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_2" title="Brachial (Kol) - Sol" cx="127" cy="80" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_3" title="Brachial (Kol) - Sağ" cx="79" cy="80" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_4" title="Radial (Bilek) - Sol" cx="132" cy="117" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_5" title="Radial (Bilek) - Sağ" cx="74" cy="117" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_6" title="Apical (Kalp)" cx="100" cy="78" r="5" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_7" title="Femoral (Kasık) - Sol" cx="109" cy="133" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_8" title="Femoral (Kasık) - Sağ" cx="97" cy="133" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_9" title="Popliteal (Diz Arkası) - Sol" cx="111" cy="165" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_10" title="Popliteal (Diz Arkası) - Sağ" cx="95" cy="165" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_11" title="Posterior Tibial - Sol" cx="112" cy="190" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_12" title="Posterior Tibial - Sağ" cx="94" cy="190" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_13" title="Dorsalis Pedis - Sol" cx="110" cy="198" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_14" title="Dorsalis Pedis - Sağ" cx="96" cy="198" r="4" fill="#E74C3C"/>
    <circle class="pulse-point" id="pulse_point_15" title="Subclavian (Köprücük)" cx="110" cy="62" r="4" fill="#E74C3C"/>
  </g>
</g>
</svg>
)rawliteral";
